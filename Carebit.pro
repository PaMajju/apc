...
win32:MINIUPNPC_INCLUDE_PATH=C:/miniupnpc-1.9-mgw
win32:MINIUPNPC_LIB_PATH=C:/miniupnpc-1.9-mgw/miniupnpc
win32:QRENCODE_INCLUDE_PATH=C:/qrencode-3.4.3-mgw
win32:QRENCODE_LIB_PATH=C:/qrencode-3.4.3-mgw/.libs		
...
LIBS += $$PWD/src/secp256k1/src/libsecp256k1_la-secp256k1.o
    ...
    isEmpty(SECP256K1_LIB_PATH) {
        win32:SECP256K1_LIB_PATH=C:/source/Carebit/src/secp256k1/.libs
		}
    isEmpty(SECP256K1_INCLUDE_PATH) {
        win32:SECP256K1_INCLUDE_PATH=C:/source/Carebit/src/secp256k1/include
    }
}
...
macx:ICON = src/qt/res/icons/Carebit.icns
macx:TARGET = "Carebit-Qt"
