...
unsigned int nStakeMinAge = 1 * 30 * 30; // 11 hours
unsigned int nModifierInterval = 1 * 30; // time to elapse before new modifier is computed
...
const string strMessageMagic = "Carebit Signed Message:\n";
