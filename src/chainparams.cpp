...
static void convertSeeds(std::vector<CAddress> &vSeedsOut, const unsigned int *data, unsigned int count, int port)
{
	...
	// weeks ago.
	const int64_t nOneWeek = 1 * 24 * 60 * 60;
...
public:
	CMainParams() {
		...
		vAlertPubKey = ParseHex("04a912320ea7658a7106385003fef77896538a382a0dcc389ff45f3c98751d9af423a014789757666259351198a8a2a628a1fd644c3232678c5845384c744ff8d7");
		nDefaultPort = 12116;
		nRPCPort = 12117;
		...
		vout.resize(1);
		vout[0].SetEmpty();
		CTransaction txNew(1, 1521981489, vin, vout, 0);
		genesis.vtx.push_back(txNew);
		genesis.hashPrevBlock = 0;
		genesis.hashMerkleRoot = genesis.BuildMerkleTree();
		genesis.nVersion = 1;
		genesis.nTime = 1521981489;
		genesis.nBits = 0x1e0ffff0;
		genesis.nNonce = 4717911;
     ...
     //std::cout << hashGenesisBlock.ToString() << std::endl;
		...
		assert(genesis.hashMerkleRoot == uint256("0x42c5767bd6e9a1092d88df5680e17ff96bda0eb11887952ca71510989348b75c"));
		assert(hashGenesisBlock == uint256("0xdb7e597a11f33d13cb10b57df48a2b59fdec56667ccae9ed5686f7ccd25cfdf2"));
		...
		strDarksendPoolDummyAddress = "Aea4vMvgYVKiMm8BPPz3myafUy6ey2nDHi";
		nLastPOWBlock = 5000;
		nPOSStartBlock = 1;
	}
...
public:
	...
	//	assert(hashGenesisBlock == uint256("0x4a5b91d5ba89186bde03fd0b635e53ee7fbef4e866265276dcb951c9eafb4f4c"));
